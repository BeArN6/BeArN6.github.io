...
$(window).load(function (){
	...
	if(windWidth < 768){
		$(".basket__row").each(function(){
			$(this).children(".basket__col_4").insertAfter( $(this).children(".basket__col_1") );
			$(this).children(".basket__col_8").insertAfter( $(this).children(".basket__col_4") );
		});
	}
	...
	$('.sidenav__text').click(function(){
		$(this).toggleClass('sidenav__text_active');
	...
	$(".sp-thumbs").slick({
        ...
        nextArrow:"<button type='button' class='slick-next pull-right'><i class='fa fa-angle-right' aria-hidden='true'></button>"
	});
});
