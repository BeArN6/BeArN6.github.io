$(document).ready(function(){
	...
	$('.banner').prepend('<img id="leftControl" class="l_arr control" src="E:/Work/1-site/css/images/left_arr.png" alt="">')
	.append('<img id="rightControl" class="r_arr control" src="E:/Work/1-site/css/images/right_arr.png" alt="">');
